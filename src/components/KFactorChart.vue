<template>
  ...
  // Datos del KPI: K-Factor promedio por mes (ejemplo)
  const kFactorData = [1.0, 1.1, 1.2, 1.3, 1.4, 1.5]
  
  // Etiquetas de cada mes para el radar
  const months = ['Mes 0', 'Mes 1', 'Mes 2', 'Mes 3', 'Mes 4', 'Mes 5']
  
  // Configuración del máximo valor para el radar (más del objetivo para mejor visual)
